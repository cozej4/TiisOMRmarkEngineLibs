...
public partial class Pages_HealthFacilityListForPlanned : System.Web.UI.Page
{
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            if ((actionList != null) && actionList.Contains("ViewHealthFacilityList") && (CurrentEnvironment.LoggedUser != null))
            {
               ...
               // this.btnSearch.Visible = actionList.Contains("SearchHealthFacility");
                ...
                if (count == 1)
                {
                    Response.Redirect("PlannedCoverageReport.aspx?hfId=" + CurrentEnvironment.LoggedUser.HealthFacilityId);
                }
