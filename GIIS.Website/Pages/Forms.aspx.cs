    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack)
        {
            ...
            if (CurrentEnvironment.LoggedUser != null)
            {
                ...
                string reportQuery = "SELECT \"REPORT\".*, \"GROUP_NAME\" FROM \"REPORT\" INNER JOIN \"REPORT_GROUP\" ON (\"REPORT\".\"GROUP_ID\" = \"REPORT_GROUP\".\"ID\") WHERE \"ACTION_ID\" IN (SELECT \"ID\" FROM \"ACTIONS\" WHERE \"NAME\" IN (" + myRoles.ToString() + ")) AND \"REPORT_TYPE\" = 'F' ORDER BY \"REPORT_GROUP\".\"GROUP_NAME\", \"REPORT\".\"REPORT_NAME\"";
