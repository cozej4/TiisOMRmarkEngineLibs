...
public partial class Pages_HealthFacilityListForStockCount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack)
        {
            ...
            if ((actionList != null) && actionList.Contains("ViewHealthFacilityList") && (CurrentEnvironment.LoggedUser != null))
            {
                ...
                gvHealthFacility.Columns[7].HeaderText = wtList["HealthFacilityListViewStockCount"];
