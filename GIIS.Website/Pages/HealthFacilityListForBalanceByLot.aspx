 ...
 ******************************************************************************
--%>
<%@ Page Title="Health Facility List For Balance - IIS" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HealthFacilityListForBalanceByLot.aspx.cs" Inherits="Pages_HealthFacilityListForBalanceByLot" EnableEventValidation="false" %>
       ...
       <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
            ...
            <Columns>
                ...
                <asp:CheckBoxField DataField="VaccinationPoint" HeaderText="VaccinationPoint" SortExpression="VaccinationPoint" />
                 <asp:TemplateField HeaderText="View Balance By Lot">
                    <ItemTemplate>
                        <a href='<%# Eval("Id", "HealthFacilityBalanceByLot.aspx?hfId={0}") %>' target="_blank">
                            <img alt='View Balance By Lot' src="../img/DispatchLines.png" />
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
