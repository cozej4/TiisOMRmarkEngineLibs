 ...
 ******************************************************************************
--%>
<%@ Page Title="Health Facility List For Adjustments - IIS" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HealtFacilityListForAdjustments.aspx.cs" Inherits="Pages_HealtFacilityListForAdjustments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" DataSourceID="odsHealthFacility" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Name">
                        <ItemTemplate>
                            <asp:HyperLink ID="hlName" runat="server" NavigateUrl='<%# Eval("Id", "HealthFacilityListForAdjustments.aspx?id={0}") %>'
                    ...
                    <asp:TemplateField HeaderText="View Adjustments">
                        <ItemTemplate>
                            <a href='<%# Eval("Id", "ViewAdjustments.aspx?hfId={0}") %>' target="_blank">
                                <img alt='View Adjustments' src="../img/DispatchLines.png" />
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
