<%@ Page Title="Cohort Coverage Report" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="CohortCoverageReport.aspx.cs" Inherits="Pages_CohortCoverageReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="lblTitle" runat="server" Text="Cohort Coverage Report" /></li>
            </ol>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-1 col-xs-1 col-sm-1 col-lg-1 clearfix"></div>
        <div class="col-md-2 col-xs-2 col-sm-2 col-lg-2 clearfix">
            <asp:Label ID="lblCommunityId" runat="server" Text="Community" />
        </div>
        <div class="col-md-3 col-xs-3 col-sm-3 col-lg-3 clearfix">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <asp:GridView ID="gvCohortCoverage" runat="server" CssClass="table table-striped table-bordered table-hover table-responsive" OnRowDataBound="gvCohortCoverage_RowDataBound" OnDataBound="gvCohortCoverage_DataBound">
