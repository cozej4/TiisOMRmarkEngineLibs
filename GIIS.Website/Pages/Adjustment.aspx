<%@ Page Title="Report Wastage" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Adjustment.aspx.cs" Inherits="Pages_Adjustment" %>
    ...
    <script type="text/javaScript">
        ...
        function cvAdjustment_Validate(sender, args) {
            var text = (document.getElementById('<%=ddlItems.ClientID%>').value == '-1' || document.getElementById('<%=ddlGtin.ClientID%>').value == '-1'
                     ...
                     || document.getElementById('<%=txtQuantity.ClientID%>').value == '' || document.getElementById('<%=ddlAdjustmentReason.ClientID%>').value == '-1');
            if (text) {
                args.IsValid = false;
                return;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="lblTitle" runat="server" Text="Make a Stock Adjustment" /></li>
            </ol>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-xs-3 col-sm-3 col-lg-3 clearfix">
            <div class="form-group">
                <asp:DropDownList ID="ddlAdjustmentReason" runat="server" CssClass="form-control" DataSourceID="odsAdjustmentReason" DataTextField="Name" DataValueField="Id">
                </asp:DropDownList>
