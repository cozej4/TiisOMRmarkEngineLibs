<%@ Page Title="Health Facility List For Balance - IIS" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HealthFacilityListForRunningBalance.aspx.cs" Inherits="Pages_HealthFacilityListForRunningBalance" %>
       ...
       <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Name">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlName" runat="server" NavigateUrl='<%# Eval("Id", "HealthFacilityListForRunningBalance.aspx?id={0}") %>'
                ...
                <asp:CheckBoxField DataField="VaccinationPoint" HeaderText="VaccinationPoint" SortExpression="VaccinationPoint" />
                 <asp:TemplateField HeaderText="View Balance">
                    <ItemTemplate>
                        <a href='<%# Eval("Id", "HealthFacilityRunningBalance.aspx?hfId={0}") %>' target="_blank">
