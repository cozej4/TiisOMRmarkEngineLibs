...
public partial class Pages_Adjustment : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack)
        {
            ...
            if ((actionList != null) && actionList.Contains("ViewMakeAdjustment") && (CurrentEnvironment.LoggedUser != null))
            {
                ...
                lblAdjustmentReason.Text = wtList["ItemTransactionAdjustment"];
               ...
               //grid header text
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    ddlAdjustmentReason.SelectedValue = o.AdjustmentId.ToString();
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                if (!String.IsNullOrEmpty(txtQuantity.Text))
                {
                    ...
                    AdjustmentReason adr = AdjustmentReason.GetAdjustmentReasonById(int.Parse(ddlAdjustmentReason.SelectedValue));
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                if (!String.IsNullOrEmpty(txtQuantity.Text))
                {
                    ...
                    o.AdjustmentId = int.Parse(ddlAdjustmentReason.SelectedValue);
