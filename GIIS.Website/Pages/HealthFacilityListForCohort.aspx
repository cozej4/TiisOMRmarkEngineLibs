 ...
 ******************************************************************************
--%>
<%@ Page Title="View Cohort Coverage Report" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HealthFacilityListForCohort.aspx.cs" Inherits="Pages_HealthFacilityListForCohort" %>
       ...
       <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
            ...
            <Columns>
                ...
                <asp:CheckBoxField DataField="VaccinationPoint" HeaderText="VaccinationPoint" SortExpression="VaccinationPoint" />
                 <asp:TemplateField HeaderText="View Cohort Coverage Report">
                    <ItemTemplate>
                        <a href='<%# Eval("Id", "CohortCoverageReport.aspx?hfId={0}") %>' target="_blank">
                            <img alt='View CohortCoverageReport' src="../img/DispatchLines.png" />
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
