...
public partial class Pages_VaccinationReportTemp : System.Web.UI.Page
{
    ...
    protected void UpdateHyperLink(object sender,EventArgs e)
    {
        ...
        DownloadLink.NavigateUrl = String.Format("{0}Vaccine_Report_Temp.pdf?j_username={3}&j_password={4}&Facility={1}&Month={2}", jasperLocation, int.Parse(HealthFacilityDropdown.SelectedValue), int.Parse(MonthDropdown.SelectedValue),
            jasperUsername,
            jasperPassword);
    }
