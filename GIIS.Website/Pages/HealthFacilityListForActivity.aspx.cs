...
public partial class Pages_HealthFacilityListForActivity : System.Web.UI.Page
{
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            if ((actionList != null) && actionList.Contains("ViewHealthFacilityList") && (CurrentEnvironment.LoggedUser != null))
            {
               ...
               // this.lblTitle.Text = wtList["HealthFacilityListPageTitle"];
                ...
                if (count == 1)
                {
                    Response.Redirect("VaccinationActivityReport.aspx?hfId=" + CurrentEnvironment.LoggedUser.HealthFacilityId);
                }
