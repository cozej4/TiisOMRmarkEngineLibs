...
public partial class Pages_HealthFacilityListForBalanceByLot : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack)
        {
            ...
            if ((actionList != null) && actionList.Contains("ViewHealthFacilityList") && (CurrentEnvironment.LoggedUser != null))
            {
                ...
                gvHealthFacility.Columns[7].HeaderText = wtList["HealthFacilityListViewBalanceByLot"];
                ...
                if (count == 1)
                {
                    Response.Redirect("HealthFacilityBalanceByLot.aspx?hfId=" + CurrentEnvironment.LoggedUser.HealthFacilityId);
                }
