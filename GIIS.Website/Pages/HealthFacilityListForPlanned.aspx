<%@ Page Title="View Planned Coverage Report" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HealthFacilityListForPlanned.aspx.cs" Inherits="Pages_HealthFacilityListForPlanned" %>
       ...
       <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Name">
                    <ItemTemplate>
                  <%--      <asp:HyperLink ID="hlName" runat="server" NavigateUrl='<%# Eval("Id", "HealthFacilityListForPlanned.aspx?id={0}") %>'
                ...
                <asp:CheckBoxField DataField="VaccinationPoint" HeaderText="VaccinationPoint" SortExpression="VaccinationPoint" />
                 <asp:TemplateField HeaderText="View Planned Coverage Report">
                    <ItemTemplate>
                        <a href='<%# Eval("Id", "PlannedCoverageReport.aspx?hfId={0}") %>' target="_blank">
                            <img alt='View Planned Coverage Report' src="../img/DispatchLines.png" />
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
