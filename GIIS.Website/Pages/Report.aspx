...
<%@ Page Title="Reports" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="_Report" %>
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="lblTitle" runat="server" Text="Reports" /></li>
            </ol>
        </div>
    </div>
    <div class="row">
