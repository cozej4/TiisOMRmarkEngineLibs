 ...
 ******************************************************************************
--%>
<%@ Page Title="Health Facility List For Stock Count - IIS" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HealthFacilityListForStockCount.aspx.cs" Inherits="Pages_HealthFacilityListForStockCount" %>
       ...
       <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Name">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlName" runat="server" NavigateUrl='<%# Eval("Id", "HealthFacilityListForStockCount.aspx?id={0}") %>'
                ...
                <asp:CheckBoxField DataField="VaccinationPoint" HeaderText="VaccinationPoint" SortExpression="VaccinationPoint" />
                 <asp:TemplateField HeaderText="View Stock Counts">
                    <ItemTemplate>
                        <a href='<%# Eval("Id", "ViewStockCount.aspx?hfId={0}") %>' target="_blank">
                            <img alt='View Stock Count' src="../img/DispatchLines.png" />
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
