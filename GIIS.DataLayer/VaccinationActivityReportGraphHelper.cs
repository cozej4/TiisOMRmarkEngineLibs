...
{
    public class VaccinationActivityReportGraphHelper
    {
        public VaccinationActivityReportGraphHelper()
        { }
        ...
        public static string GetUrl(DataTable dt, string title)
        {
            ...
            string url = string.Format(@"http://chart.apis.google.com/chart
               ...
               &chdl={3}
               &chls=1|1
               &chtt={4}", colors, size, data, vaccines, title, arange);
